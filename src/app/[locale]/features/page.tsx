    ...
    <div className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-ray-blue to-blue-600 rounded-2xl p-8 text-white">
            <h2 className="text-3xl font-bold mb-4">
              {isSpanish ? '¿Listo para Transformar tu Restaurante?' : 'Ready to Transform Your Restaurant?'}
            </h2>
            <p className="text-xl mb-6 opacity-90">
              {isSpanish 
                ? 'Descubre cómo nuestras soluciones pueden hacer crecer tu negocio.'
                : 'Discover how our solutions can grow your business.'
              }
            </p>
            <Link 
              href={`/${locale}/demo`}
