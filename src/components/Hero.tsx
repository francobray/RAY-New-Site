            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              <div className="relative w-full max-w-[600px] sm:max-w-[460px] md:max-w-[520px] lg:max-w-[560px]">
                ...
                />
                  ...
                  <div className="absolute bottom-24 md:bottom-28 lg:bottom-32 left-1/2 -translate-x-1/2 w-[min(94vw,30rem)] md:w-[32rem] lg:w-[36rem] max-w-xl z-10 flex justify-center">
                    <div id="ray-widget" className="min-h-[165px]" style={{ minHeight: '165px', height: '165px' }}></div>
                  </div>
              </div>
            </div>
