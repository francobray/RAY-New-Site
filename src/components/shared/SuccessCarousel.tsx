...
const successStories = [
  ...
  },
  {
    ...
    title: 'Cuban Restaurant Excellence',
    restaurantName: 'Havana 1957',
    metric: '+$58,000',
    period: 'monthly revenue increase',
    description: 'How Havana 1957 elevated their authentic Cuban dining experience with digital marketing',
  ...
  },
  {
    ...
    metric: '+$42,000',
    period: 'monthly revenue increase',
    description: 'How Oh! Mexico stood out for authentic Mexican cuisine in a competitive market',
  ...
  },
  {
    ...
    title: 'Italian Seafood Excellence',
    restaurantName: 'Mercato Della Pescheria',
    metric: '+$65,000',
    period: 'monthly revenue increase',
    description: 'How Mercato Della Pescheria became the premium Italian seafood destination',
  ...
  },
  {
    id: 6,
    ownerName: 'Barsecco',
    title: 'Italian Cocktail Mastery',
    restaurantName: 'Barsecco',
    metric: '+$52,000',
    period: 'monthly revenue increase',
    description: 'How Barsecco became the premier destination for Italian artisanal cocktails',
  ...
  },
  {
    ...
    title: 'Modern Grill Restaurant',
    restaurantName: 'Salty Flame',
    metric: '+$78,000',
    period: 'monthly revenue increase',
    description: 'How Salty Flame became the go-to destination for modern grilled cuisine',
  ...
  },
  {
    ...
    metric: '+$92,000',
    period: 'monthly revenue increase',
    description: 'How Paperfish became the reference for sustainable seafood dining',
  ...
  },
  {
    id: 9,
    ownerName: 'Marabu',
    title: 'Caribbean Fusion Restaurant',
    restaurantName: 'Marabu',
    metric: '+$68,000',
    period: 'monthly revenue increase',
    description: 'How Marabu became the premium destination for Caribbean fusion cuisine',
  ...
  },
  {
    ...
    title: 'Authentic Cuban Coffee Shop',
    restaurantName: 'Cortadito Cafe',
    metric: '+$82,000',
    period: 'monthly revenue increase',
    description: 'How Cortadito Cafe became the reference destination for authentic Cuban coffee',
...
].filter(story => story.slug !== null && story.slug !== 'green-eat' && story.slug !== 'la-birra-bar' && story.slug !== 'tea-connection') // Only include stories with dedicated pages, excluding removed ones
