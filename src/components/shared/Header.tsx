...
const Header: React.FC<HeaderProps> = ({ locale }) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { 
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: locale === 'es' ? 'Casos de Éxito' : 'Case Studies', path: `/${locale}/case-studies` },
    ...
    { 
      ...
      dropdownItems: [
        ...
        { name: locale === 'es' ? 'Asóciate con RAY' : 'Partner with RAY', path: `/${locale}/partner` },
        { name: locale === 'es' ? 'Carreras' : 'Careers', path: `/${locale}/careers` },
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50 h-[77px]">
                            ...
                            {item.dropdownItems?.map((dropdownItem) => (
                              dropdownItem.path.startsWith('http') ? (
                                <a
                                  ...
                                  role="menuitem"
                                  data-analytics="nav"
                                  aria-label={`Visit ${dropdownItem.name} - opens in new tab`}
                                >
                                  {dropdownItem.name}
                                </a>
                              ) : (
