...
const Footer: React.FC<FooterProps> = ({ locale }) => {
  ...
  return (
    <footer className="bg-ray-dark-900 text-white pt-12">
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link
                  href={`/${locale}/partner`}
                  className="text-ray-gray hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-ray-blue focus:ring-offset-2 rounded-md px-1 py-1"
                  aria-label={locale === 'es' ? 'Página de Asociarse con RAY' : 'Partner with RAY page'}
                >
                  {locale === 'es' ? 'Asóciate con RAY' : 'Partner with RAY'}
                </Link>
              </li>
              <li>
                <a
