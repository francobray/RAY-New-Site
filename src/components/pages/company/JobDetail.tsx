...
const JobDetail: React.FC<JobDetailProps> = ({ job, locale }) => {
  ...
  const aboutText = locale === 'es' ? {
    ...
    aboutP1: 'RAY es el sistema de crecimiento con IA para restaurantes locales.',
    ...
    tractionP1: 'Desde 2020, hemos generado decenas de millones en ingresos y procesado más de medio billón de dólares en pedidos online. 1 de cada 5 latinoamericanos ha usado un sitio web de RAY.',
    ...
    locationP1: 'RAY es una empresa remoto-first, global con sede en Buenos Aires. Para algunos de nuestros roles priorizamos la colaboración presencial en nuestras oficinas. La mayoría de nuestros compañeros están distribuidos por todo el mundo. Por favor revisa la descripción del rol y discute con tu reclutador para más detalles sobre ubicación.',
  } : {
    aboutTitle: '👋 About RAY',
    aboutP1: 'RAY is the AI growth system for local restaurants.',
    ...
    tractionP1: 'Since 2020, we\'ve generated tens of millions in revenue and processed over half a billion dollars of online orders. 1 in 5 Latin Americans have used a RAY website.',
