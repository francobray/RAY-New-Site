      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            <Image src="/images/success-stories/Dolcezza.png" alt="La Panera Rosa fresh pastries" width={1200} height={600} className="w-full h-[400px] md:h-[500px] object-cover" />
