...
const Bookings: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Simplify Bookings. Connect with Every Customer.</title>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Product",
            "name": "RAY Bookings Platform",
            "description": "Comprehensive booking management platform for restaurants to maximize table occupancy and enhance guest experience.",
            "brand": {
              "@type": "Brand",
              "name": "RAY"
            },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left relative">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-ray-dark-900 leading-tight mb-6">
                Simplify Bookings. Connect with {' '}
