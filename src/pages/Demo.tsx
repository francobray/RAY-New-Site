...
const Demo = () => {
  ...
  return (
    <>
      <SEOHead
        title="Book Your Free Demo - RAY Restaurant Sales Platform"
        description={`See the #1 restaurant sales platform in action. Book your free 20-minute demo and discover how ${COPY.COMPANY.NAME} can increase your revenue through walk-ins, orders, and bookings.`}
        canonical="/demo"
      />
