...
const TempleCraftCaseStudy: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Temple Craft Wynwood Success Story - 259% Google Maps Growth | RAY Case Study</title>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 backdrop-blur-sm rounded-2xl p-6 border border-yellow-500/20">
                    ...
                    <div className="text-gray-300 text-sm font-medium">Google Maps Views</div>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                <p>
                  Temple Craft is "the" place and the excuse to come together. We are cold craft beer. 
                  We are the "aaaah" of the first sip. Since 2010, with more than 40 bars—now arriving 
                  in Miami. Continuing to enjoy beer, share music, and create culture. Cheers!
                </p>
              </div>

              <div className="space-y-4 pt-6">
                <div className="flex items-center text-gray-300">
                  <Instagram className="w-5 h-5 text-pink-400 mr-3" />
                  <span className="font-medium">@templemiami</span>
                </div>
                <div className="flex items-center text-gray-300">
                  <MapPin className="w-5 h-5 text-yellow-400 mr-3" />
                  <span className="font-medium">Wynwood, Miami</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 border border-gray-800">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-xl border border-yellow-500/20">
                  <div className="w-3 h-3 bg-yellow-400 rounded-full mr-4"></div>
                  <span className="font-medium text-white">Local SEO</span>
                </div>
                <div className="flex items-center p-4 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl border border-green-500/20">
                  <div className="w-3 h-3 bg-green-400 rounded-full mr-4"></div>
                  <span className="font-medium text-white">Listings Management</span>
                </div>
                <div className="flex items-center p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-500/20">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            {/* Results Visual */}
            <div className="mt-12">
              <div className="bg-gradient-to-br from-black to-gray-900 rounded-3xl p-8 border border-gray-800">
                <LazyImage
                  src="/images/Temple-KPIs-1-png.webp"
                  alt="Temple Craft Wynwood performance metrics showing dramatic improvement in Google Maps visibility and customer engagement"
                  width={800}
                  height={500}
