...
export const COPY: Record<Locale, any> = {
  es: {
    ...
    HOMEPAGE: {
      HERO: {
        TITLE: 'Aumenta los ingresos impulsando más',
        TITLE_HIGHLIGHT: 'delivery, reservas y tráfico en tu restaurante',
      ...
      TIERS: [
        {
          ...
          price: 'Gratis',
          priceDetail: 'Prueba RAY gratis',
          description: 'Obtén un escaneo integral de la presencia online de tu restaurante y ve dónde te encuentras.',
          features: [
            'Escaneo y calificación gratuita del restaurante',
          ...
          ctaText: 'Comenzar Escaneo Gratis',
        ...
        },
        {
          id: 'growth',
          name: 'Crecimiento',
          tagline: 'Más popular para restaurantes en crecimiento',
          price: '$299',
          priceDetail: '/mes',
          description: 'Todo lo que necesitas para aumentar visitas, pedidos y reservas con nuestra plataforma comprobada.',
          features: [
            'Todo en Inicial, además:',
            'Optimización de SEO local',
            'Actualizaciones automáticas de Google Business Profile',
            'Monitoreo de reseñas y plantillas de respuesta',
            'Herramientas de engagement de clientes',
            'Integraciones de reservas y pedidos',
            'Dashboard de rendimiento y analíticas',
            'Garantía de aumento del 30%+ en direcciones de Google Maps',
        ...
        },
        {
          id: 'enterprise',
          name: 'Empresarial',
          tagline: 'Para restaurantes con múltiples ubicaciones',
          price: 'Personalizado',
          priceDetail: 'Habla con ventas',
          description: 'Funciones avanzadas, soporte dedicado y soluciones personalizadas para grupos de restaurantes.',
          features: [
            'Todo en Crecimiento, además:',
            ...
            'Acceso a API',
            'Gerente de cuenta dedicado',
            'Soporte prioritario (teléfono, email, chat)',
            'SLAs personalizados',
