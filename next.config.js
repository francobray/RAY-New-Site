    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' blob: https://www.googletagmanager.com https://www.google-analytics.com https://grader.rayapp.io https://static.cloudflareinsights.com https://maps.googleapis.com https://unpkg.com https://*.vapi.ai https://vapi.ai https://cdn.vapi.ai https://us.i.posthog.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://*.google.com https://*.doubleclick.net https://grader.rayapp.io https://static.cloudflareinsights.com https://cloudflareinsights.com https://maps.googleapis.com https://*.vapi.ai https://vapi.ai https://cdn.vapi.ai https://api.vapi.ai wss://*.vapi.ai https://*.daily.co https://c.daily.co wss://*.daily.co https://franbreciano.app.n8n.cloud https://us.i.posthog.com; font-src 'self' data: https://fonts.gstatic.com; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self';",
          },
        ],
      },
      {
